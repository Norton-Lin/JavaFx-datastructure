...
public class ClockController {
    ...
    private void SetOnClock() {
        ...
        this.Once.setToggleGroup(toggleGroup);
        this.PerDay.setToggleGroup(toggleGroup);
        this.PerWeek.setToggleGroup(toggleGroup);//将所有按钮放入同一个组
...
//        this.systemTime.setClock(time, this.NameOfClock.getText(), type[0]);
    ...
    private void SetFastSpeed() {
        ...
        this.Hundred.setToggleGroup(toggleGroup);
        this.SixHundred.setToggleGroup(toggleGroup);
        this.Thousand.setToggleGroup(toggleGroup);//将所有按钮放入同一个组
